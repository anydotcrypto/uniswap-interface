...
export const UNISWAP_ROUTER_V3_ADDRESS = '0xc31178f913f99663bdf0ff03aa456794b183592c'
...
export class DaiSwapClient {
  ...
  public async relay(
    ...
    const estimatedGas = await this.signer.provider!.estimateGas({ to: dataTx.to, data: dataTx.data })
